...
- Demo video: linked privately during App Store submission.
- Onboarding video: linked privately during App Store submission.
...
- **Privacy policy:** `/privacy.html` in the production app; use `https://packbridge.app/privacy.html` once the branded domain is verified.
