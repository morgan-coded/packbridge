...
<body>
  <div class="app">
    <aside class="side">
      ...
      <div class="side-foot">${h(SHOP_DOMAIN)}<br />Demo data for App Store review</div>
    </aside>
    <main class="main">
      <div class="top">
        <div>
...
function feature(data: Awaited<ReturnType<typeof loadData>>) {
  return `<!doctype html><html><head><meta charset="utf-8" /><style>
    * { box-sizing:border-box; }
    ...
    <section class="dash"><div class="top"><strong>PackBridge dashboard</strong><span>${h(SHOP_DOMAIN)}</span></div><div class="grid">
